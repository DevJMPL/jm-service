...
export function AuthSplitLayout({
  ...
  imageUrl = "/images/pexels-yurika-4151484.jpg",
}: AuthSplitLayoutProps) {
  return (
    <div className="h-screen overflow-hidden bg-[#fbfbfc]">
      <div className="grid h-full grid-cols-1 lg:grid-cols-[1fr_1.02fr]">
        <section className="flex h-full flex-col justify-between px-8 py-6 sm:px-12 lg:px-14 xl:px-16">
          <motion.div
          ...
          <motion.div
            ...
            className="shrink-0 pt-4 text-sm text-[#a0a5b5]"
          >
